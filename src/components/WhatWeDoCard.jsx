  ...
  return (
    <div ref={whatWeDoRef} className="flex justify-around mr-12">
      <div
        ...
        } hover:cursor-pointer h-[26rem] w-60 bg-[rgba(104,35,162,0.9)]  rounded-xl flex flex-col items-center`}
      >
        <div
      ...
      <div
        ...
        } hover:pointer h-[26rem] w-60 bg-[rgba(104,35,162,0.9)]  rounded-xl flex flex-col items-center`}
      >
        <div
          className={`h-40 w-40 bg-[#b975f1] ${
            isInView
      ...
      <div
        ...
        } h-[26rem] w-60 bg-[rgba(104,35,162,0.9)] rounded-xl flex flex-col items-center`}
      >
        <div
          className={`h-40 w-40 bg-[#b975f1] ${
            isInView
